class Api::V1::OpportunitiesController < Api::V1::ApiController
  ...
  def opportunity_params
    { title: params[:title], company: params[:company],
      work_description: params[:work_description],
      required_abilities: params[:required_abilities], salary: params[:salary],
      grade: params[:grade], submit_end_date: params[:submit_end_date],
      address: params[:address], headhunter_id: params[:headhunter_id] }
  end
end

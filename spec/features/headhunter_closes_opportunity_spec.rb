...
feature 'headhunter closes opportunity' do
    ...
    scenario 'and must see only his opportunities' do
        headhunter = create(:headhunter, email: 'headhunter@email.com')
        another_headhunter = create(:headhunter, email: 'another_headhunter@email.com')
        opportunity = create(:opportunity, title: 'Desenvolvedor Júnior Ruby on Rails', headhunter: headhunter)
        another_opportunity = create(:opportunity, title: 'Engenheiro de software', headhunter: another_headhunter)

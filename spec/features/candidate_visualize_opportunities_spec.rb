...
feature 'candidate visualize opportunities' do
    scenario 'list at index' do
        ...
        another_opportunity = create(:opportunity, title: 'Analista de suporte', headhunter: headhunter)
        third_opportunity = create(:opportunity, title: 'Engenheiro de Software', headhunter: headhunter)

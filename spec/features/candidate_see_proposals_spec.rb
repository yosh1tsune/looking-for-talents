...
feature 'candidate see proposals' do
    scenario 'successfully' do
      ...
      subscription = create(:subscription, opportunity: opportunity, candidate: candidate, status: :approved)

      proposal = create(:proposal, subscription: subscription, opportunity: opportunity)
    ...
    scenario 'and choose one' do
      ...
      another_opportunity = create(:opportunity, title: 'Engenheiro de Software', headhunter: headhunter)

      subscription = create(:subscription, opportunity: opportunity, candidate: candidate)
      
      another_subscription = create(:subscription, opportunity: another_opportunity, candidate: candidate)

      proposal = create(:proposal, role: 'Desenvolvedor Ruby on Rails', subscription: subscription, opportunity: opportunity)

      another_proposal = create(:proposal, role: 'Analista de suporte', subscription: another_subscription, opportunity: another_opportunity)

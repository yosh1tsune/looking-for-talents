...
describe 'Opportunities Management' do
    ...
    context 'create' do
        it 'successfully' do
            ...
            post api_v1_opportunities_path, params: {title: 'Engenheiro de Software', company: 'RR Systems', 
                                                  ...
                                                  salary: '8.000,00', grade: 'Especialista', submit_end_date: 14.days.from_now, 
                                                  address: 'Avenida Paulista, 1000 - Bela Vista', headhunter_id: headhunter.id}
    ...
    context 'update' do
        it 'sucessfully' do
            ...
            patch api_v1_opportunity_path(opportunity), params: {title: 'Engenheiro de Software', company: 'Google', 
                work_description: 'Análise e desenvolvimento de projetos', 
                required_abilities: 'Graduação em T.I., Metodologias de desenvolvimento ágil', 
                salary: '8.000,00', grade: 'Especialista', submit_end_date: 28.days.from_now, 
                address: 'Alameda Santos, 1239', headhunter_id: opportunity.headhunter_id}
            ...
            expect(opportunity.work_description).to eq 'Análise e desenvolvimento de projetos'
    ...
    context 'delete' do
        it 'sucessfully' do
            ...
            }.to change(Opportunity, :count).from(1).to(0)
